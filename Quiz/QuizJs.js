...
function displayResults(){
          ...
          if (getRadioValue(document.quiz.q1)==3){
		   ...
		   if (getRadioValue(document.quiz.q2)==2){
              correctScore+=2;
              result[1]="correct";
          }
          else{
...
document.getElementById("endDisplay").innerHTML="<span>" + output + "</span><br><span>" +timeCount+ "</span><br><br><span>" + one + "</span><br><span>" + two + "</span><br><span>" + three + "</span><br><span>" + four + "</span><br><span>" + five + "</span><br><span>" + six + "</span><br><span>" + seven + "</span><br><span>" + eight + "</span><br><span>" + nine + "</span><br><span>" + ten + "</span><br>";
